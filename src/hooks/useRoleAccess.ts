...
export const ALL_MODULE_KEYS = [
  ...
  'manual', 'operator-manual', 'access', 'plan-accion', 'wa-numbers', 'wa-chat', 'atencion-cliente', 'communications', 'cumplimiento', 'iluminacion', 'eventos', 'mis-datos',
...
export const DEFAULT_ROLE_MODULES: Record<string, RoleModules> = {
  super_admin: {
    desktopModules: ['dashboard','condos','equipment','operators','residents','visitors','incidents','expenses','facilities','parcels','users','access','plan-accion','wa-numbers','wa-chat','atencion-cliente','communications','cumplimiento','iluminacion','eventos'],
