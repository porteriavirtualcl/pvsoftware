      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-gray-900/50 p-6 rounded-2xl border border-gray-800">
        <div className="space-y-0.5">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-3xl font-black text-white tracking-tight uppercase italic">Visitantes</h2>
          </div>
          <p className="text-gray-500 text-base font-medium italic">Gestión de accesos inteligentes y pases autorizados.</p>
        </div>
        
        <button
          onClick={handleOpenAdd}
          className="group relative flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-500 text-white font-black py-3 px-6 rounded-xl transition-all shadow-xl shadow-blue-600/20 overflow-hidden active:scale-95 text-base uppercase tracking-widest"
        >
          <Plus size={18} />
          ...
          {visitors.map((visitor, i) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className={`px-4 py-1.5 rounded-full text-base font-black uppercase tracking-[0.1em] border ${
              ...
              <div className="space-y-0.5 mb-6">
                ...
                <div className="flex items-center gap-2 text-gray-500 font-bold text-base uppercase tracking-widest">
                  <Building2 size={12} />
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white/5 rounded-2xl p-4 space-y-1">
                  <p className="text-base text-gray-500 uppercase font-black tracking-widest">Fecha Validez</p>
                  <p className="text-base font-bold text-gray-200">{visitor.date}</p>
                </div>
                <div className="bg-white/5 rounded-2xl p-4 space-y-1">
                  <p className="text-base text-gray-500 uppercase font-black tracking-widest">Patente LPR</p>
                  <p className="text-base font-bold text-blue-400">{visitor.licensePlate || 'PEATORAL'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/5">
                ...
                <button className="flex items-center gap-2 text-base font-black text-white px-4 py-2 bg-white/5 rounded-xl hover:bg-white/10 transition-all uppercase tracking-widest">
                  Compartir
            ...
            <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 50, opacity: 0 }} className="relative w-full max-w-2xl bg-gray-900 border border-white/5 rounded-[3rem] p-10 shadow-[0_0_100px_rgba(0,0,0,0.5)] max-h-[90vh] overflow-y-auto no-scrollbar">
              <div className="flex items-center justify-between mb-10">
                <div className="space-y-1">
                  ...
                  <p className="text-gray-500 font-medium text-base">Completa los datos para generar el acceso automático.</p>
                </div>
              ...
              <form onSubmit={handleSaveVisitor} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {(profile?.role === 'super_admin' || profile?.condoScope === 'all') && (
                    <div className="col-span-1 md:col-span-2 space-y-3">
                      <label className="text-base font-black text-gray-400 uppercase tracking-widest ml-1">Condominio Destino</label>
                  ...
                  <div className="space-y-3">
                    <label className="text-base font-black text-gray-400 uppercase tracking-widest ml-1">Nombre Invitado</label>
                    <div className="relative">
                  ...
                  <div className="space-y-3">
                    <label className="text-base font-black text-gray-400 uppercase tracking-widest ml-1">Patente Vehicular (Opcional)</label>
                    <div className="relative">
                ...
                <div className="bg-white/5 rounded-[2.5rem] p-8 space-y-6">
                  <div className="flex items-center gap-3 mb-2 text-blue-400"><Clock size={18} /><span className="font-black text-base uppercase tracking-widest">Ventana de Validez</span></div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                       <p className="text-[11px] text-gray-500 font-bold uppercase pl-1">Fecha</p>
                    ...
                    <div className="space-y-2">
                      <p className="text-[11px] text-gray-500 font-bold uppercase pl-1">Entrada</p>
                    ...
                    <div className="space-y-2">
                      <p className="text-[11px] text-gray-500 font-bold uppercase pl-1">Salida</p>
                ...
                <div className="flex items-center gap-4 p-5 bg-blue-600/10 rounded-2xl border border-blue-500/20">
                  ...
                  <p className="text-base text-blue-400 font-black uppercase tracking-wide leading-relaxed">
                ...
                <button type="submit" disabled={syncing} className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-5 rounded-[1.5rem] transition-all shadow-2xl shadow-blue-600/30 flex items-center justify-center gap-3 text-3xl">
            ...
            <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="relative w-full max-w-sm bg-white rounded-[3rem] p-10 text-gray-950">
              <div className="flex flex-col items-center">
                <div className="w-full flex justify-between items-center mb-10">
                   <span className="text-base font-black uppercase tracking-[0.2em] text-blue-600">Pase Digital Activo</span>
                ...
                <div className="text-center space-y-2 mb-10">
                  <h3 className="text-xl font-black uppercase tracking-tight">{selectedVisitor.visitorName}</h3>
                  <p className="text-base font-black text-gray-400 uppercase tracking-widest">Acceso {profile?.condoName || 'Condominio'}</p>
                </div>
                <div className="w-full space-y-3 mb-10">
                   <div className="flex justify-between py-3 border-b border-gray-100"><span className="text-base font-bold text-gray-400 uppercase">Validez</span><span className="text-base font-black">{selectedVisitor.date}</span></div>
                   <div className="flex justify-between py-3 border-b border-gray-100"><span className="text-base font-bold text-gray-400 uppercase">Patente LPR</span><span className="text-base font-black text-blue-600">{selectedVisitor.licensePlate || 'Peatonal'}</span></div>
                </div>
        ...
        {deletingVisitor && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-sm bg-gray-900 border border-white/5 rounded-[2.5rem] p-10 text-center">
                ...
                <h3 className="text-xl font-black text-white italic mb-2">¿Anular Invitación?</h3>
                <p className="text-gray-500 text-base font-medium mb-10">El código QR de <span className="text-white font-bold">{deletingVisitor.visitorName}</span> será desactivado.</p>
