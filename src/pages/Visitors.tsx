...
const Visitors = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      const visitorData = snapshot.docs.map(d => ({ id: d.id, ...d.data() })) as Visitor[];
              ...
              <form onSubmit={handleSaveVisitor} className="space-y-8">
                ...
                <div className="bg-white/5 rounded-[2.5rem] p-8 space-y-6">
                  <div className="flex items-center gap-3 mb-2 text-blue-400">
                    <Clock size={18} />
                    <span className="font-black text-[10px] uppercase tracking-widest">Ventana de Validez</span>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                      <p className="text-[9px] text-gray-500 font-bold uppercase pl-1">Fecha</p>
                      <input required type="date" value={newVisitor.date}
                    ...
                    <div className="space-y-2">
                      ...
                      <input required type="time" value={newVisitor.entryTime}
                    ...
                    <div className="space-y-2">
                      ...
                      <input required type="time" value={newVisitor.exitTime}
