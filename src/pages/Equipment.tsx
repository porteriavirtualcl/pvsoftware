        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full sm:w-64 bg-gray-950 border border-gray-800 rounded-xl py-3 pl-12 pr-4 text-white text-sm focus:border-blue-600 outline-none"
            />
          </div>
        ...
        {filteredItems.map((item) => (
          <motion.div layout key={item.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-blue-500/50 transition-all group shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 border-t border-gray-800">
               <div><p className="text-[10px] font-black text-gray-600 uppercase">Último Manto.</p><p className="text-xs font-bold text-gray-300">{item.lastMaintenance}</p></div>
               <div><p className="text-[10px] font-black text-gray-600 uppercase">Siguiente</p><p className="text-xs font-bold text-blue-500">{item.nextMaintenance}</p></div>
            </div>
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95 }} animate={{ scale: 1 }} className="relative w-full max-w-lg bg-gray-900 border border-gray-800 rounded-[2.5rem] p-10">
                <h3 className="text-2xl font-black text-white italic mb-8">{editingEquipment ? 'Editar Equipo' : 'Nuevo Activo'}</h3>
                <form onSubmit={handleSave} className="space-y-6">
                   <div className="space-y-1">
                      <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Nombre del Equipo</label>
                   ...
                   <div className="grid grid-cols-2 gap-6">
                      <div className="space-y-1">
                        <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Típo/Modelo</label>
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Estado</label>
                   ...
                   <div className="space-y-1">
                      <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Ubicación Física</label>
