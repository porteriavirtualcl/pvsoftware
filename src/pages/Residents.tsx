      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-gray-900/50 p-6 rounded-2xl border border-gray-800">
        <div className="space-y-0.5">
          <div className="flex items-center gap-3">
            <h2 className="text-3xl font-black text-white italic tracking-tight uppercase">Gestión de Residentes</h2>
            <div className="bg-blue-600/10 text-blue-500 px-2 py-0.5 rounded-full text-[11px] font-black uppercase tracking-widest border border-blue-500/20">
              {residents.length} Totales
            </div>
          </div>
          <p className="text-gray-500 text-base font-medium italic">Administración de accesos, unidades y dispositivos LPR.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full sm:w-64 bg-gray-950 border border-gray-800 rounded-xl py-3 pl-12 pr-4 text-white text-base focus:border-blue-600 outline-none transition-all"
            />
          </div>
          <button
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  <span className={`px-3 py-1 rounded-full text-base font-black uppercase tracking-widest border ${
                  ...
                  <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">{resident.condoName}</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-950/50 p-3 rounded-xl border border-gray-800/50">
                    <p className="text-[11px] text-gray-600 font-black uppercase tracking-tighter mb-1">Unidad/Depto</p>
                  ...
                  <div className="bg-gray-950/50 p-3 rounded-xl border border-gray-800/50">
                    <p className="text-[11px] text-gray-600 font-black uppercase tracking-tighter mb-1">Acceso LPR</p>
                    <div className="flex items-center gap-2 text-base font-bold text-gray-300">
                ...
                {resident.plates && resident.plates.length > 0 && (
                  <div className="flex flex-wrap gap-2">
                    {resident.plates.map((plate, idx) => (
                      <span key={idx} className="bg-gray-800 text-base font-black px-2 py-0.5 rounded text-gray-400 font-mono">{plate}</span>
                    ))}
                  </div>
                )}
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 20 }} className="relative w-full max-w-2xl bg-gray-900 border border-gray-800 rounded-[3.5rem] p-10 overflow-y-auto max-h-[90vh] no-scrollbar shadow-[0_0_100px_rgba(37,99,235,0.1)]">
              <div className="flex justify-between items-center mb-10">
                <div>
                  <h3 className="text-xl font-black text-white italic">{editingResident ? 'Editar Ficha' : 'Nuevo Residente'}</h3>
                  <p className="text-gray-500 text-base mt-1">Configuración técnica y de acceso para el recinto.</p>
                </div>
              ...
              <form onSubmit={handleSave} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                   <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Nombre Completo</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Email de Acceso</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Contraseña Provisoria</label>
                    <div className="relative">
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em] ml-1">Unidad / N° Casa</label>
                    <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em]">Estado</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em]">Perfil</label>
                  ...
                  {profile?.role === 'super_admin' && (
                    <div className="space-y-2">
                      <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em]">Condominio</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-gray-950/50 p-8 rounded-3xl border border-gray-800">
                  <div className="space-y-4">
                     <div className="flex items-center gap-3">
                        ...
                        <label htmlFor="fac" className="text-base font-bold text-gray-300 cursor-pointer">Acceso a Instalaciones</label>
                     </div>
                     <div className="flex items-center gap-3">
                        ...
                        <label htmlFor="qr" className="text-base font-bold text-gray-300 cursor-pointer">Puede generar Pases QR</label>
                     </div>
                  </div>
                  <div className="space-y-2">
                    <label className="text-base font-black text-gray-400 uppercase tracking-[0.2em]">Patentes Vehiculares (LPR)</label>
                    <div className="relative">
                       <Car size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-blue-500" />
                       <input type="text" value={formData.plates?.join(', ')} onChange={(e) => setFormData({...formData, plates: e.target.value.split(',').map(p => p.trim().toUpperCase()).filter(p => p !== '')})} className="w-full bg-gray-950 border border-gray-800 rounded-xl py-3 pl-12 pr-4 text-white font-mono text-base" placeholder="ABCD12, FGHI34..." />
                    </div>
                    <p className="text-[11px] text-gray-600 font-bold italic mt-1 italic">Sincronización automática con cámaras.</p>
                  </div>
                </div>
                ...
                <div className="bg-blue-600/5 p-5 rounded-2xl border border-blue-500/20 flex gap-4">
                  ...
                  <p className="text-base text-blue-400 font-black tracking-wide leading-relaxed uppercase">
        ...
        {deletingResident && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
             ...
             <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} className="relative w-full max-w-sm bg-gray-900 border border-gray-800 rounded-[2.5rem] p-10 text-center shadow-2xl">
                ...
                <h3 className="text-xl font-black text-white mb-2 italic">¿Anular Residente?</h3>
                <p className="text-gray-500 text-base font-medium mb-10 leading-relaxed">Se revocará el acceso de <span className="text-white font-bold">{deletingResident.name}</span> a todas las instalaciones y cámaras LPR.</p>
